...
public class AlbumTest {
    ...
    // atributos para albuns de selos
    ...
    public void setUp() {
        ...
        this.repositorioSelos = new Repositorio<>("selos_colecionaveis", TAMANHO_DO_ALBUM, "Selo");
    ...
    private void popularAlbumSelos(int[] posicoesDesejadas) {
        Pacotinho<Selo> pacote = new Pacotinho<>(this.repositorioSelos, posicoesDesejadas);
    ...
    @Test
    public void testarTiposDeAlbum() {

        // roda o equivalente ao testarPossuiRepetidaParaFigurinhaRepetida() para um album de selos.

        popularAlbumSelos(new int[] {1, 2, 3});
        assertFalse(this.albumSelos.possuiItemRepetido(2));

        popularAlbumSelos(new int[] {2, 8, 9});
        assertTrue(this.albumSelos.possuiItemRepetido(2));

        // roda para um album de figurinhas.

        testarPossuiRepetidaParaFigurinhaRepetida();
