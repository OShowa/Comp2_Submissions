...
public class TuiterLiteTest {
    ...
    @Test
    public void testeTamanhoTuite() throws UsuarioDesconhecidoException, TamanhoMaximoExcedidoException {
...
//        tuite.anexarAlgo(new Object());  // essa linha, se fosse descomentada, daria erro de compilação
    ...
    @Test
    public void testarMultiplosSimbolosDeHashtag() throws UsuarioDesconhecidoException, TamanhoMaximoExcedidoException {
